...
<div class="container">
 ...
 $sql="SELECT cim , leiras , kep  FROM galeria JOIN oktato o on o.id = f.oktato_id where  f.email= '$email'"; 
 $sqlgaleria="SELECT cim , leiras , kep from  galeria "; 
 $galeria = $db->query($sql);

      $sqlgaleria = $galeria->fetch_assoc();
      $cim=$galeria["cim"];
            $leiras=$galeria["leiras"];
            $kep=$galeria["kep"];
